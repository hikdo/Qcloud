 ...
 * 视频云模块文件上传请求
 */
class Requpload extends Request {
    ...
    public static function send($paramArray, $secretId, $secretKey, $request, $data, $https = false) {
        ...
        $plainText = Sign::makeSignPlainText($paramArray, $request['method'], $request['host'], $request['uri']);    
        $paramArray['Signature'] = Sign::sign($plainText, $secretKey);
